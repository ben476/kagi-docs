...
export default defineConfig({
  ...
  vite: {
    ...
    plugins: [
      SearchPlugin({
        origin: "https://mix.sidekick-ui.pages.dev/",
      }),
    ],
  },
...
function sidebarKagi() {
  return [
      ...
      items: [
        {
          ...
          items: [
            ...
            {
              text: "Jobs",
              link: "/kagi/company/hiring-kagi",
              collapsed: true,
              items: [
                {
                  text: "Jobs at Kagi Search",
                  link: "/kagi/company/hiring-kagi",
                },
                {
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Email Support",
              link: "/kagi/support-and-community/email-support",
            },
            {
              text: "Share with Friends and Family",
              link: "/kagi/support-and-community/share-kagi",
            },
          ],
        },
        { text: "Frequently Asked Questions", link: "/kagi/faq/faq" },
        {
          ...
          items: [
            {
              text: "Translations",
              link: "/kagi/support-and-community/contribute_translations",
            },
            {
              text: "Open Source",
              link: "/kagi/support-and-community/open-source",
            },
            {
              text: "Contributors",
              link: "/kagi/support-and-community/contributors",
            },
    ...
    },
    {
      ...
      items: [
        {
          text: "Why Pay for Search",
          link: "/kagi/why-kagi/why-pay-for-search",
        },
      ...
      items: [
        {
          ...
          items: [
            ...
            {
              text: "Set Kagi as Your Default Search Engine",
              link: "/kagi/getting-started/setting-default",
            },
            {
              text: "Application Integrations",
              link: "/kagi/getting-started/application-integrations",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "Website Info & Personalized Results",
              link: "/kagi/features/website-info-personalized-results",
            },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Lenses", link: "/kagi/settings/lenses" },
            {
              ...
              link: "/kagi/settings/personalized-results",
            },
          ...
          items: [
            {
              ...
              items: [
                ...
                { text: "Base API URL", link: "/kagi/api/intro/api-url" },
                {
                  ...
                  link: "/kagi/api/intro/response-format",
                },
                {
                  text: "Image Proxy URLs",
                  link: "/kagi/api/intro/image-proxy-urls",
                },
              ],
            },
  ...
  return [
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              text: "Getting help and contributing",
              link: "/orion/support-and-community/",
            },
            {
            ...
            },
            {
              ...
              link: "/orion/support-and-community/os-versions",
            },
            {
              text: "Product Roadmap & Feedback Forum",
              link: "/orion/support-and-community/roadmap-feedback-forum",
            },
            {
              text: "Discord Server",
              link: "/orion/support-and-community/discord-server",
            },
            {
              text: "Email Support",
              link: "/orion/support-and-community/email-support",
            },
            {
              text: "macOS Keyboard Shortcuts",
              link: "/orion/support-and-community/keyboard-shortcuts",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "Translations",
              link: "/orion/support-and-community/contribute_translations",
            },
          ],
        },
      ],
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Importing Data From Other Browsers",
              link: "/orion/getting-started/importing",
            },
            {
              text: "Default Search Engine",
              link: "/orion/getting-started/search-engine",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "Troubleshooting Extension Issues",
              link: "/orion/support-and-community/troubleshooting/troubleshooting-extension-issues",
            },
            {
            ...
            {
              text: "Troubleshooting FastMail Issues",
              link: "/orion/support-and-community/troubleshooting/troubleshooting-fastmail-issues",
            },
            {
              text: "Reporting a bug",
              link: "/orion/support-and-community/troubleshooting/bug-reporting",
            },
          ],
        },
        { text: "Orion+", link: "/orion/orion-plus/orion-plus" },
        {
          ...
          items: [
            ...
            {
              text: "Press and Hold Shortcuts",
              link: "/orion/features/press-and-hold-shortcuts",
            },
            { text: "Profiles", link: "/orion/features/profiles" },
            { text: "Quick Searches", link: "/orion/features/quick-searches" },
            {
              text: "Viewing Web Archives",
              link: "/orion/features/web-archives",
            },
            ...
            { text: "Low Power Mode", link: "/orion/features/low-power-mode" },
            {
              ...
              link: "/orion/features/allow-copy-paste",
            },
            {
              text: "Edit Text on Page",
              link: "/orion/features/edit-text-on-page",
            },
            { text: "Float on Top", link: "/orion/features/float-on-top" },
            {
              text: "Show Console Errors",
              link: "/orion/features/show-errors",
            },
            {
              text: "Block Auto-Play",
              link: "/orion/features/block-auto-play",
            },
            ...
            { text: "Web Apps", link: "/orion/features/web-apps" },
            {
              ...
              link: "/orion/features/programmable-buttons",
            },
            {
              text: "Custom Blocklists",
              link: "/orion/features/custom-blocklists",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "iOS & iPadOS Extensions",
              link: "/orion/browser-extensions/ios-ipados-extensions",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "Configure Ad & Tracking Blocking",
              link: "/orion/privacy-and-security/ad-tracking-blocking",
            },
            {
            ...
            {
              text: "Protecting Privacy",
              link: "/orion/privacy-and-security/protecting-privacy",
            },
            {
              text: "Preventing Fingerprinting",
              link: "/orion/privacy-and-security/preventing-fingerprinting",
            },
          ],
        },
